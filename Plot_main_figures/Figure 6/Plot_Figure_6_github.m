...
n_color=1;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.LIP.r_chosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.LIP.r_chosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.LIP.r_chosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.LIP.r_chosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.LIP.r_chosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.LIP.r_chosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=2;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.FEF.r_chosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.FEF.r_chosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.FEF.r_chosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.FEF.r_chosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.FEF.r_chosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.FEF.r_chosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=3;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.PFC.r_chosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.PFC.r_chosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.PFC.r_chosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.PFC.r_chosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.PFC.r_chosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.PFC.r_chosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=1;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.LIP.r_unchosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.LIP.r_unchosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.LIP.r_unchosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.LIP.r_unchosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.LIP.r_unchosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.LIP.r_unchosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=2;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.FEF.r_unchosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.FEF.r_unchosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.FEF.r_unchosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.FEF.r_unchosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.FEF.r_unchosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.FEF.r_unchosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=3;
hold on
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.PFC.r_unchosen_contra_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.PFC.r_unchosen_contra_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.PFC.r_unchosen_contra_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
shadedErrorBar(Figure_6A.window_start_list(4:end),mean(mean(Figure_6A.PFC.r_unchosen_ipsi_boot(4:end,:,:),2),3),[prctile(mean(Figure_6A.PFC.r_unchosen_ipsi_boot(4:end,:,:),2),95,3),prctile(mean(Figure_6A.PFC.r_unchosen_ipsi_boot(4:end,:,:),2),5,3)]',{'--','color',Figure_6A.color_for_ROI(n_color,:),'LineWidth',2},2)
...
n_color=1;
hold on
shadedErrorBar(Figure_6D.window_start_list(4:end),mean(mean(Figure_6D.LIP.r_chosen_contra_chosen_global_boot(4:end,:,:),2),3),[prctile(mean(Figure_6D.LIP.r_chosen_contra_chosen_global_boot(4:end,:,:),2),95,3) prctile(mean(Figure_6D.LIP.r_chosen_contra_chosen_global_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6D.color_for_ROI(1,:),'LineWidth',2},2)
shadedErrorBar(Figure_6D.window_start_list(4:end),mean(mean(Figure_6D.FEF.r_chosen_contra_chosen_global_boot(4:end,:,:),2),3),[prctile(mean(Figure_6D.FEF.r_chosen_contra_chosen_global_boot(4:end,:,:),2),95,3) prctile(mean(Figure_6D.FEF.r_chosen_contra_chosen_global_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6D.color_for_ROI(2,:),'LineWidth',2},2)
shadedErrorBar(Figure_6D.window_start_list(4:end),mean(mean(Figure_6D.PFC.r_chosen_contra_chosen_global_boot(4:end,:,:),2),3),[prctile(mean(Figure_6D.PFC.r_chosen_contra_chosen_global_boot(4:end,:,:),2),95,3) prctile(mean(Figure_6D.PFC.r_chosen_contra_chosen_global_boot(4:end,:,:),2),5,3)]',{'-','color',Figure_6D.color_for_ROI(3,:),'LineWidth',2},2)
