...
subplot(2,1,2)
vs = violinplot([mean_update_model_neg_sess', mean_update_neg_sess'],{'Behavioral','Neural'},'ViolinColor',[0 0 0],'ShowData',true,'ShowMean',true,'ShowMedian',true);
hold on
